...
class MakkiLife extends StatefulWidget {
  @override
  _MakkiLifeState createState() => _MakkiLifeState();
}

class _MakkiLifeState extends State<MakkiLife> {
  ...
  _getData() async {
    var firebaseDocs = await _database.dataBySubtitle("Makki life");
