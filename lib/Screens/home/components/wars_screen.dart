...
class Wars extends StatefulWidget {
  final String events;

  const Wars({Key key, this.events}) : super(key: key);
  @override
  _WarsState createState() => _WarsState();
}

class _WarsState extends State<Wars> {
  ...
  _getData() async {
    var firebaseDocs = await _database.dataBySubtitle("Ghazwat");
